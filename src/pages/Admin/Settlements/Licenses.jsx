...
export default function Licenses() {
  ...
  const columns = [
    { title: 'Nazwa licencji', dataIndex: 'id', sorter: 'text', filter: 'text' },
    { title: 'Stan', dataIndex: 'name', sorter: 'text', filter: 'select' },
    { title: 'Czas do wygaśnięcia', dataIndex: 'type', sorter: 'text', filter: 'text' },
    { title: 'Liczba licencji', dataIndex: 'sale_date', sorter: 'text', filter: 'text' },
  ...
  return (
    <div className={classes.root}>
      <div className='d-flex d-between'>
        <Button type='primary' onClick={() => { navigate('/admin/license/add') }}>Dodaj licencję</Button>
        <Exporter />
      </div>
