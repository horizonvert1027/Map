  ...
  return (
    <div className={classes.root}>
      <div className='d-flex d-between'>
        ...
        <Button onClick={() => navigate('/admin/user')} type='ghost' danger>Powrót do listy użytkowników</Button>
      </div>
        ...
        <Col span={8}>
          <Row gutter={[0, 15]}>
            <Col span={24} className='bg-white p-15 shadow-light'>
              <Row gutter={[15, 15]}>
                <Col span={8}>
                  <Button size='large' type='primary' block icon={<img src={PdfPng} alt="" />} />
                </Col>
                <Col span={8}>
                  <Button size='large' type='primary' block icon={<img src={PreviewPng} alt="" />} />
                </Col>
                <Col span={8}>
                  <Button size='large' type='primary' block icon={<img src={TrashPng} alt="" />} />
                </Col>
                <Col span={24}>
